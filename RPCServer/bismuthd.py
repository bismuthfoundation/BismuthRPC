...
@methods.add
async def listaccounts(context=None):
    # mockup
    listaccounts = {"":99.99996160}
    return listaccounts

@methods.add
async def getaccount(address, context=None):
    # mockup
    getaccount = ""
    return getaccount

@methods.add
async def getaddressesbyaccount(account, context=None):
    # mockup
    getaddressesbyaccount = ["moPhStktszZGwtVjziE7eoQ76ATQqfhMtK","n4aNErEjyafirvMJNCKhFJgBUow9JZnXPk"]
    return getaddressesbyaccount

@methods.add
async def listreceivedbyaddress(context=None):
    # mockup
...
@methods.add
async def listsinceblock(blockhash='', context=None):
    # mockup
